...
function isDirectSubCategory(sub: SubCategory | null): sub is DirectSubCategory {
  return sub !== null && sub !== undefined && 'directDisplay' in sub;
}
...
n                    setActiveStandalone(standaloneSection);
                  }}
                >
                  {section.title}
